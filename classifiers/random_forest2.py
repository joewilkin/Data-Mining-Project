# code for improved random forest classifier
# created after observing presentations 
...
with Spinner():
    forest = RandomForestClassifier(random_state=47, n_estimators=300, max_depth=10)
...
predictions_file = "../predictions/random_forest_predictions2.csv"
